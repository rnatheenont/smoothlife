...
const dayCircleStyle: Record<DayInfo["status"], string> = {
  normal: "bg-white text-brand-800 shadow-xs",
  recovery: "bg-white text-brand-800 shadow-xs",
  today: "bg-white text-brand-800 shadow-lg ring-4 ring-amber-300/70 scale-110",
  recoverable: "bg-white text-amber-700 border-2 border-amber-400 shadow-xs",
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            <span
              className={`grid h-12 w-12 shrink-0 place-items-center rounded-full ${
                cycle?.day3RewardClaimed ? "bg-brand-gradient text-white shadow-xs" : "bg-brand-gradient-soft text-brand-800"
              }`}
            >
              <Gift size={20} />
            </span>
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-2">
            <span
              className={`grid h-12 w-12 shrink-0 place-items-center rounded-full ${
                cycle?.day7RewardClaimed ? "bg-brand-gradient text-white shadow-xs" : "bg-brand-gradient-soft text-brand-800"
              }`}
            >
              <Sparkles size={20} />
            </span>
        ...
        <div>
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <span
                className={`grid h-12 w-12 shrink-0 place-items-center rounded-full ${
                  data.monthlyAttendance.rewarded ? "bg-brand-gradient text-white shadow-xs" : "bg-brand-gradient-soft text-brand-800"
                }`}
              >
