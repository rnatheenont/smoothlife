...
export default function MobileStickyBar({
  ...
  return (
    <div
      ...
      className="lg:hidden fixed bottom-[55px] inset-x-0 z-[85] flex items-center gap-3 border-t border-surface-line bg-white/95 backdrop-blur-md px-4 py-2.5 pb-[calc(0.625rem+env(safe-area-inset-bottom))] shadow-[0_-4px_12px_rgba(0,0,0,0.05)] animate-fadeUp"
    >
      {children}
    </div>
  );
