...
// The fallback checkout — redirects to Shopify's own hosted checkout page.
// This is what actually runs today (see app/checkout/page.tsx: rendered
// whenever 2C2P isn't configured, which is always right now). Once real
// 2C2P credentials exist, CustomCheckout takes over instead and this stays
// as the safety-net path for if 2C2P is ever misconfigured/down.
