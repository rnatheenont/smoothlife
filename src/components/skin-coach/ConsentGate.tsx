    ...
    <div className="container-page py-10 md:py-14 max-w-2xl">
      <div className="rounded-xl2 border border-slate-100 shadow-card p-6 md:p-8">
        ...
        <div className="text-sm text-slate-600 space-y-3 mb-6">
          <p>ถ่ายเซลฟีหน้าตรง 1 รูป (เพิ่มมุมอื่นได้ถ้าต้องการ) น้อง Smoothie จะประเมินลักษณะผิวและอายุผิว แล้วแนะนำสินค้าและขั้นตอนดูแลผิวที่เหมาะกับคุณ</p>
          <p className="font-semibold text-brand-ink">ภาพถ่ายใบหน้าถือเป็นข้อมูลอ่อนไหวตามกฎหมาย เราจึงขอแจ้งให้ทราบว่า</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>รูปที่ถ่ายจะถูกส่งไปวิเคราะห์กับระบบ AI แบบชั่วคราวเท่านั้น เราไม่เก็บรูป เว้นแต่คุณเลือกเองตอนบันทึกผลว่า “เก็บรูปหน้าตรงไว้เทียบก่อน-หลัง” ซึ่งจะเก็บในที่ส่วนตัว เห็นเฉพาะคุณ ทีมงานไม่เห็นรูป และลบได้ทุกเมื่อ</li>
            <li>ผลวิเคราะห์แสดงในเบราว์เซอร์ของคุณ และจะถูกบันทึกก็ต่อเมื่อคุณกด “บันทึกผลนี้” เท่านั้น — เก็บเฉพาะตัวเลขผลสแกนไว้ในบัญชีของคุณ ไม่เก็บรูป ทีมดูแลลูกค้าของเราเห็นตัวเลขนี้เพื่อช่วยแนะนำคุณ ไม่ส่งต่อให้บุคคลภายนอก และลบได้ทุกเมื่อ</li>
