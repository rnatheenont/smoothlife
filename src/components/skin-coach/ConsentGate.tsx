      ...
      <div className="rounded-xl2 border border-slate-100 shadow-card p-6 md:p-8">
        ...
        <div className="text-sm text-slate-600 space-y-3 mb-6">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>ผลวิเคราะห์แสดงในเบราว์เซอร์ของคุณ ไม่ถูกส่งให้บุคคลอื่น และจะถูกบันทึกก็ต่อเมื่อคุณกด “บันทึกผลนี้” เท่านั้น — เก็บเฉพาะตัวเลขผลสแกนไว้ในบัญชีของคุณ ไม่เก็บรูป และลบได้ทุกเมื่อ</li>
